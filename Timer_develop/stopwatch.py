...
# Colors
BACKGROUND_COLOR = '#FAFAFA'       # Black background
TEXT_COLOR = '#5D5B5C'             # Gray-white text
BUTTON_COLOR = '#F0CBDD'           # Light green buttons
BUTTON_HOVER_COLOR = '#D5A5BC'     # Darker green on hover
BUTTON_PRESSED_COLOR = '#896778'   # Even darker green on press
